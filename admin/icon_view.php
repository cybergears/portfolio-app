...
//Page Vars
$title  = array('#','Icon','Icon Name', 'Action' );
...
$model_name = 'Manage Icons';
$page_title = APP_NAME . ' | ' . $db_query->capital_word($model_name);

$table_name = 'app_icons';
$table_id = 'icon_id';
$edit_page = ADMIN_PATH.'/icon-add/';
$current_page = ADMIN_PATH.'/icon-view/';
    ...
    <main class="main-content">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>You can add more icons by going to add new icon menu. Check <a target="_BLANK" href="https://iconscout.com/icons/social-media">this</a> website for more icons.</p>
                  ...
                  <table id="datatable" class="table" data-toggle="data-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><?php echo html_entity_decode ($d['icon']); ?></td>
                           <td><?php echo $d['icon_name']; ?></td>
