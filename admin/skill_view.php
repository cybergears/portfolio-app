...
//Page Vars
$title  = array('#','Skill Name','Level', 'Status', 'Action' );
...
$model_name = 'Manage Skills';
$page_title = APP_NAME . ' | ' . $db_query->capital_word($model_name);

$table_name = 'skills';
$table_id = 'skill_id';
$edit_page = ADMIN_PATH.'/skill-add/';
$current_page = ADMIN_PATH.'/skill-view/';
    ...
    <main class="main-content">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>Skill Management allows the user to created, delete, and update the skill(s).</p>
                  ...
                  <table id="datatable" class="table" data-toggle="data-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><?php echo $d['skill_name']; ?></td>
                           <td><?php echo $d['skill_level'].'%'; ?></td>
