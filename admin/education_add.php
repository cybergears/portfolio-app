...
if (isset($_GET['edit'])) {
    ...
    $course = $fetch_details[0]['course'];
    $title = $fetch_details[0]['title'];
    $college = $fetch_details[0]['college'];
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="course" value="<?php echo $course; ?>" class="form-control" id="course" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="college" value="<?php echo $college; ?>" class="form-control" id="college" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label for="description" class="form-label">Education Summary (Not More Than 300 Characters.)</label>
                                ...
                                <div class="col-md-12">
                                    <label for="temp_data" class="form-label">Do you currently study here?</label>
