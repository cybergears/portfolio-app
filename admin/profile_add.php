...
if(isset($_REQUEST['mode']) == "save"){
    ...
    if($_FILES['admin_profile_pic']){
        $tmpFilePath = $_FILES['admin_profile_pic']['tmp_name'];
        $main_path = "../assets/images/";

        $gallery_image_name = rand(1,100000).time().'-'.$_FILES['admin_profile_pic']['name'];
        $filePath = $main_path.$gallery_image_name;

        if(move_uploaded_file($tmpFilePath, $filePath)){
            $payload['admin_profile_pic'] = $gallery_image_name;
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="admin_username" value="<?php echo $admin_username; ?>" class="form-control" id="admin_username" disabled required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="admin_level" value="<?php echo $admin_level; ?>" class="form-control" id="admin_level" disabled required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label for="admin_profile_pic" class="form-label">Choose Profile Picture</label>
                                    <input type="file" accept=".jpg,.png,.jpeg" name="admin_profile_pic"  class="form-control" id="admin_profile_pic">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
