...
//Page Vars
$menu_title  = array('#','Menu Name','Type', 'Parent', 'Action' );
...
$model_name = 'Manage Admin Menu';
$page_title = APP_NAME . ' | ' . $db_query->capital_word($model_name);

$table_name='admin_menu';
$table_id='menu_id';
$edit_page = ADMIN_PATH.'/menu-add/';
$current_page = ADMIN_PATH.'/menu-view/';
    ...
    <main class="main-content">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>Menu Management allows the user to created, delete, and update the menu.</p>
               <div class="table-responsive">
                  <table id="datatable" class="table" data-toggle="data-table">
                     <thead class="table-dark">
                        <tr>
                            <?php foreach($menu_title as $t){?>
                                <th><?php echo $t; ?></th>
                            <?php }?>
                        </tr>
                     </thead>
                     <tbody>
                        <?php
                            ...
                            foreach($data as $d){
                                ...
                                $parent = '#';
                                if($d['child_id']!=0){
                                    $name = $db_query->runQuery("SELECT * FROM ".$table_name." WHERE ".$table_id."='".$d['child_id']."'");
                                    $parent = $name[0]['item_name'];
                                }
