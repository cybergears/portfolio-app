...
//Page Vars
$title  = array('#','Course Name','Title', 'College', 'Duration', 'Status', 'Action' );
...
$model_name = 'Manage Education';
$page_title = APP_NAME . ' | ' . $db_query->capital_word($model_name);

$table_name = 'education';
$table_id = 'education_id';
$edit_page = ADMIN_PATH.'/education-add/';
$current_page = ADMIN_PATH.'/education-view/';
    ...
    <main class="main-content">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>Education Management allows the user to created, delete, and update the Education Detail(s).</p>
