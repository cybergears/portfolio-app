...
//Page Vars
$title  = array('#','Name','Email', 'Role','Added On', 'Status', 'Action' );
...
$model_name = 'Manage Admin';
$page_title = APP_NAME . ' | ' . $db_query->capital_word($model_name);

$table_name = 'admin';
$table_id = 'admin_id';
$edit_page = ADMIN_PATH.'/admin-add/';
$current_page = ADMIN_PATH.'/admin-view/';
...
/** Data Query */
$data = $db_query->runQuery("SELECT * FROM ".$table_name." WHERE admin_id!=1");
    ...
    <main class="main-content">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>Admin Management allows the user to created, delete, and update the admin data.</p>
                     ...
                     <tbody>
                        <?php
                            ...
                            foreach($data as $d){
                                ...
                                }else if($d['admin_level']=='b'){
                                    $admin_level = 'Administrator';
                                }else if($d['admin_level']=='z'){
                        ...
                        <tr>
                           ...
                           <td><?php echo $d['added_on']; ?></td>
                           <td><?php echo $status; ?></td>
                           <td>
                            <?php if($d['admin_level']!='z'){ ?>
