...
//Page Vars
$title  = array('#','Template Name','Type', 'Parent', 'Action' );
...
$model_name = 'Manage Template';
$page_title = APP_NAME . ' | ' . $db_query->capital_word($model_name);

$table_name = 'page_template';
$table_id = 'id';
$edit_page = ADMIN_PATH.'/template-add/';
$current_page = ADMIN_PATH.'/template-view/';
    ...
    <main class="main-content">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>Template Management allows the user to created, delete, and update the template.</p>
