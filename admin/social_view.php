...
//Page Vars
$title  = array('#','Network Name','Icon', 'Url', 'Action' );
...
$model_name = 'Manage Social Profile(s)';
$page_title = APP_NAME . ' | ' . $db_query->capital_word($model_name);

$table_name = 'social_profiles';
$table_id = 'social_id';
$edit_page = ADMIN_PATH.'/social-add/';
$current_page = ADMIN_PATH.'/social-view/';
    ...
    <main class="main-content">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>Social Management allows the user to created, delete, and update the social profile(s).</p>
                     ...
                     <tbody>
                        <?php
                            ...
                            foreach($data as $d){
                                ...
                                $icon = $db_query->getItem('app_icons','icon_id',$d['icon']);
                            
                        ?>
                        <tr>
                           <td><?php echo $counter; ?></td>
                           <td><?php echo $d['name']; ?></td>
                           <td style="color:<?php echo $d['color'] ?>;"><?php echo html_entity_decode($icon->icon); ?></td>
                           <td><a href="<?php echo $d['url']; ?>" target="_BLANK">View</a></td>
                           <td>
