...
//Page Vars
$title  = array('#','Company Name','Designation', 'Duration', 'Status', 'Action' );
...
$model_name = 'Manage Experience';
$page_title = APP_NAME . ' | ' . $db_query->capital_word($model_name);

$table_name = 'experience';
$table_id = 'experience_id';
$edit_page = ADMIN_PATH.'/experience-add/';
$current_page = ADMIN_PATH.'/experience-view/';
    ...
    <main class="main-content">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <p>Experience Management allows the user to created, delete, and update the Experience(s).</p>
